...
![The distribution of the coffee data, which is quite right-skewed.](/src/assets/coffee-data.webp)
...
![Comparison between the normal- and t-distribution, showing that as the degrees of freedom gets large, the t-distribution converges to the normal distribution. Both are bell curves.](/src/assets/t-vs-norm.webp)
...
![A roughly normally distributed collection of bootstrapped means.](/src/assets/bootstrapped-means.webp)
