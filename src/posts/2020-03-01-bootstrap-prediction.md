...
![Plot of linear regression fit on the non-linear data with the two prediction intervals, with the bootstrapped interval being slightly narrower.](/prediction-bootstrap-nonlinear.png)
...
![Plot of decision tree fit on same data as above. The bootstrap interval is fairly wide and the normal theory interval is basically non-existent.](/prediction-bootstrap-nonlinear-tree.png)
