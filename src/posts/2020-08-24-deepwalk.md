...
This post is part of my series on graph algorithms:
  ...
  2. DeepWalk
  3. <router-link to="/posts/2021-05-30-graph-convolutional-neural-networks">Graph Convolutional Neural Networks</router-link>
...
![A diagram of the SkipGram architecture, which takes an input word and attempts to predict one of the neighbouring words.](/src/assets/skipgram.webp)
...
![A connected graph with 20 groupings, each having 5 nodes](/src/assets/deepwalk-clique-graph.webp)
...
![A plot of the loss, which converges to around 2](/src/assets/deepwalk-loss.webp)
...
![The same graph as before, but the cliques now have different colours](/src/assets/deepwalk-clique-graph-coloured.webp)
