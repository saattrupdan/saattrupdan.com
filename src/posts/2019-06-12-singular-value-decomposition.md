...
![orthogonal transformation](/orthogonal.webp)

It's **diagonal** if it only stretches/shrinks in the axis directions:

![diagonal transformation](/diagonal.webp)
...
![eigendecomposition](/eigendecomposition.webp)
...
![symmetric transformation](/symmetric.webp)
...
![symmetric positive semi-definite transformation](/positivesemidefinite.webp)
...
![singular value decomposition](/svd.webp)
