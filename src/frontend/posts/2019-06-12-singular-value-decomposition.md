...
![orthogonal transformation](/src/frontend/assets/img/orthogonal.webp)

It's **diagonal** if it only stretches/shrinks in the axis directions:

![diagonal transformation](/src/frontend/assets/img/diagonal.webp)
...
![eigendecomposition](/src/frontend/assets/img/eigendecomposition.webp)
...
![symmetric transformation](/src/frontend/assets/img/symmetric.webp)
...
![symmetric positive semi-definite transformation](/src/frontend/assets/img/positivesemidefinite.webp)
...
![singular value decomposition](/src/frontend/assets/img/svd.webp)
