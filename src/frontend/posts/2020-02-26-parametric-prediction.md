...
![Linear data with additive normal noise and a fitted linear regression line.](/src/frontend/assets/img/prediction-data.webp)
...
![The same data as before but with a way too narrow confidence interval.](/src/frontend/assets/img/prediction-confidence.webp)
...
![Plot of the sample residuals, which are roughly normally distributed.](/src/frontend/assets/img/prediction-residuals.webp)
...
![Plot of the prediction interval, nearly covering all the true values](/src/frontend/assets/img/prediction-normal-pi.webp)
...
![Plot of the prediction interval around the random forest predictions, which is way too narrow](/src/frontend/assets/img/prediction-random-forest.webp)
...
![Plot of the prediction interval around the decision tree predictions, which has length zero](/src/frontend/assets/img/prediction-decision-tree.webp)
