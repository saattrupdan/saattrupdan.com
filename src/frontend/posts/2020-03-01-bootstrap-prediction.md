...
identical.](/src/frontend/assets/img/prediction-bootstrap-linear.webp)
...
follows the asymmetry.](/src/frontend/assets/img/prediction-bootstrap-linear-lognormal.webp)
...
non-existent.](/src/frontend/assets/img/prediction-bootstrap-linear-tree.webp)
...
narrower.](/src/frontend/assets/img/prediction-bootstrap-nonlinear.webp)
...
![Plot of decision tree fit on same data as above. The bootstrap interval is fairly
wide and the normal theory interval is basically
non-existent.](/src/frontend/assets/img/prediction-bootstrap-nonlinear-tree.webp)
