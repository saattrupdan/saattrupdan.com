...
tomorrow. The leaves each contain a single value.](/src/frontend/assets/img/qrf-decision-tree.webp)
...
corresponds to the previous diagram.](/src/frontend/assets/img/qrf-decision-tree2.webp)
...
decreases, reaching close to zero around ~800 rentals](/src/frontend/assets/img/qrf-response.webp)
...
80.9%.](/src/frontend/assets/img/qrf-1leaf.webp)
...
intervals.](/src/frontend/assets/img/qrf-coverage-analysis.webp)
...
widths are very narrow (less than approx 50)](/src/frontend/assets/img/qrf-in-out-interval.webp)
...
intervals are really narrow](/src/frontend/assets/img/qrf-1leaf-in-out.webp)
...
93.5% coverage of the bootstrap.](/src/frontend/assets/img/qrf-padded.webp)
