...
One notable weakness of the quantile prediction intervals is that **the model is
...
most of the residuals](/src/frontend/assets/img/quantile-linear-regression.webp)

The most interesting use case of quantile regression to me is in conjunction with
...
![Plot of quantile MLP prediction interval, where the interval encloses most of the
residuals](/src/frontend/assets/img/quantile-linear-mlp.webp)
...
throughout](/src/frontend/assets/img/quantile-linear-heteroscedastic.webp)
...
ones](/src/frontend/assets/img/quantile-non-linear.webp)
...
residual.](/src/frontend/assets/img/quantile-non-linear-overfit.webp)

It looks a bit strange, which is because the intervals have nearly collapsed to zero
