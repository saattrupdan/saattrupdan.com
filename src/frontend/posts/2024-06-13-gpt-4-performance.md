...
<img src="/src/frontend/assets/img/gpt4-drop.webp" alt="Line plot of GPT-4 models, separated into each Germanic language" class="centered-image" style="width: min(650px, 100%);" />
...
<img src="/src/frontend/assets/img/gpt4-llama.webp" alt="Bar plot of Germanic ScandEval performance of GPT-4 models and Llama-70b models" class="centered-image" style="width: min(450px, 100%);" />
