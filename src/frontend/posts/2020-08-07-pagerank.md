...
![Diagram of a random web surfer](/src/frontend/assets/img/random-web-surfer.webp)
...
the numbers on the outgoing edges of a node sum to one](/src/frontend/assets/img/markov-chain.webp)
...
pair of nodes that did not already have an edge](/src/frontend/assets/img/graph-completion.webp)
