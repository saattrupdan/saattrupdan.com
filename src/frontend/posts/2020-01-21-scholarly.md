...
<figure>
  <img
    src="/src/frontend/assets/img/arxiv_example.webp"
...
As my laptop is low on memory I had to come up with a way to store all this data in an
...
<figure>
  <img
    src="/src/frontend/assets/img/exploits_of_a_mom.webp"
...
One naive solution to this would be to translate the logits to probabilities, perform
...
<figure class="centered-image">
  <img
    src="/src/frontend/assets/img/vector_comparison_mcat.webp"
  ...
  />
  <img
    src="/src/frontend/assets/img/vector_comparison_cat.webp"
    alt="Comparison of model performance when trained on the homemade FastText vectors and the pre-trained GloVe vectors. FastText wins massively."
    style="width:50%;"
  />
  <figcaption class="centered">
...
<figure class="centered-image">
  <img
    src="/src/frontend/assets/img/master_cats.webp"
  ...
  />
  <img
    src="/src/frontend/assets/img/all_cats.webp"
...
<figure class="centered-image">
  <img
    src="/src/frontend/assets/img/logreg_master_cats.webp"
    alt="Comparison of the logistic regression with the SHA-RNN on the master categories"
    style="width:50%;"
  />
  <img
    src="/src/frontend/assets/img/logreg_all_cats.webp"
